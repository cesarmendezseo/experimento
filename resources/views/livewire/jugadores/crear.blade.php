                    ...
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                wire:model="dni"{{ $dni ? 'readonly' : '' }}></input>
                            @error('dni')
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                wire:model="nombre" placeholder="Ingrese nombre "></input>
                            @error('nombre')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                wire:model="apellido" placeholder="Ingrese Apellido "></input>
                            @error('apellido')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="mb-4">
                            <label for="exampleFormControlInput2"
                                class="block text-gray-700 text-sm font-bold mb-2">Nacimiento</label>
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                type="date" wire:model="nacimiento"
                                placeholder="Ingrese fecha de nacimiento "></input>
                            @error('nacimiento')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                wire:model="domicilio" placeholder="Ingrese domicilio "></input>
                            @error('domicilio')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
